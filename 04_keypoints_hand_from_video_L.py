...
#start = time.time()
for i in range(10):
  while(os.path.exists("./DATA/Video_L/{}/{}train_{}.mp4".format(i,i,j))):
    j += 1
  for k in range(j):
    if(not(os.path.exists("./DATA/Video_L/{}/{}train_{}".format(i,i,k)))):
        cam = cv2.VideoCapture("./DATA/Video_L/{}/{}train_{}.mp4".format(i,i,k))
        data = []
        ...
        dataframe.to_csv("./DATA/Video_L/{}/{}train_{}".format(i,i,k), index=False)
        print("./DATA/Video_L/{}/{}train_{} saved".format(i,i,k))
