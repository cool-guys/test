...
x_1 = MaxPooling2D(pool_size=(3, 3), strides=(1, 1))(x_1)
x_1 = Flatten()(x_1)
x_1 = Dense(units=256, activation='relu')(x_1)
x_1 = Dropout(0.5)(x_1)
...
model.summary()
plot_model(model, to_file='test.svg',show_shapes=True)
model.compile(loss='categorical_crossentropy',
                optimizer='rmsprop',
                metrics=['accuracy'])

model.fit_generator(train_generator(),steps_per_epoch=200, epochs=100)

scores = model.evaluate_generator(test_generator(),steps=20)
pd = model.predict_generator(test_generator(), steps=20)
print(np.argmax(pd,1))
