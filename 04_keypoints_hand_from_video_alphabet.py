...
#start = time.time()
for i in range(26):
  while(os.path.exists("./DATA/Video/{}/{}train_{}.mp4".format(chr(97+i),chr(97+i),j))):
    j += 1
    
  for k in range(j):
    print(k)
    if(not(os.path.exists("./DATA/Video/{}/{}train_{}".format(chr(97+i),chr(97+i),k)))):
        cam = cv2.VideoCapture("./DATA/Video/{}/{}train_{}.mp4".format(chr(97+i),chr(97+i),k))
        data = []
        ...
        dataframe.to_csv("./DATA/Video/{}/{}train_{}".format(chr(97+i),chr(97+i),k), index=False)
        print("./DATA/Video/{}/{}train_{} saved".format(chr(97+i),chr(97+i),k))
